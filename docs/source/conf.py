...
htmlhelp_basename = 'wait-for-itdoc'
...
latex_documents = [
    (master_doc, 'wait-for-it.tex', 'wait-for-it Documentation',
     'Travis Clarke', 'manual'),
]
...
man_pages = [
    (master_doc, 'wait-for-it', 'wait-for-it Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wait-for-it', 'wait-for-it Documentation',
     author, 'wait-for-it', 'One line description of project.',
     'Miscellaneous'),
]
